...
namespace AASS
{
    class Level08 : Level
    {
        ...
        public override void Initialize(int level,SpaceShip alitsa,SpaceShip atsin)
        {
            ...
            var tinyMeteorWave = new MeteorWave("TinyMeteor",tinyMeteorVariations,3,3,70f,6.0f);
            ...
            var smallMeteorWave = new MeteorWave("SmallMeteor",smallMeteorVariations,1,8,85f,8.0f);
            ...
            var medMeteorWave = new MeteorWave("MedMeteor",medMeteorVariations,2,5,100f,12.0f);
            ...
            var bigMeteorWave = new MeteorWave("BigMeteor",bigMeteorVariations,1,1,125f,25.0f);
        ...
        private void CollisionActions(GameObject player)
        {
            ...
            bigMeteorAndPlayer.Add(new HealthAction(player.Name,-25));
