...
namespace AASS
{
    class Level05 : Level
    {
        ...
        public override void Initialize(int level,SpaceShip alitsa,SpaceShip atsin)
        {
            ...
            var tinyMeteorWave = new MeteorWave("TinyMeteor",tinyMeteorVariations,3,5,70f,8.0f);
            ...
            var smallMeteorWave = new MeteorWave("SmallMeteor",smallMeteorVariations,2,6,85f,6.0f);
            ...
            var medMeteorWave = new MeteorWave("MedMeteor",medMeteorVariations,1,2,90f,18.0f);
            ...
            _universe = new Universe(_background,_collision,meteorWaves,new ShieldPowerUpWave(60f,_levelCountdownTime/6));
