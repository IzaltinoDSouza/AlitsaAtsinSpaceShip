...
namespace AASS
{
    class Level06 : Level
    {
        ...
        public override void Initialize(int level,SpaceShip alitsa,SpaceShip atsin)
        {
            ...
            var tinyMeteorWave = new MeteorWave("TinyMeteor",tinyMeteorVariations,3,3,70f,8.0f);
            ...
            var smallMeteorWave = new MeteorWave("SmallMeteor",smallMeteorVariations,3,6,85f,6.0f);
            ...
            var medMeteorWave = new MeteorWave("MedMeteor",medMeteorVariations,2,4,90f,18.0f);
