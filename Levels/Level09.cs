...
namespace AASS
{
    class Level09 : Level
    {
        ...
        public override void Initialize(int level,SpaceShip alitsa,SpaceShip atsin)
        {
            ...
            var smallMeteorWave = new MeteorWave("SmallMeteor",smallMeteorVariations,5,8,85f,9.0f);
            ...
            var medMeteorWave = new MeteorWave("MedMeteor",medMeteorVariations,3,6,100f,12.0f);
            ...
            var bigMeteorWave = new MeteorWave("BigMeteor",bigMeteorVariations,1,2,125f,30.0f);
